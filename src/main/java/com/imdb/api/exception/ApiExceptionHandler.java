...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {	
	...
	public ResponseEntity<?> handleParametroIncorreto(InvalidDataAccessApiUsageException ex, WebRequest request) {		
		...
		String detail = String.format("Parâmetro inválido. Corriga e informe um parâmetro válido.");			
	...
	public ResponseEntity<?> handlePropriedadeInvalida(PropertyReferenceException ex, WebRequest request) {		
		...
		String detail = String.format("O valor do parâmetro de URL '%s' é uma propriedade inexistente para o tipo %s. "
				+ "Corriga e informe uma propriedade válida.", ex.getPropertyName(), ex.getType());			
	...
	public ResponseEntity<?> handleAcessDenied(AccessDeniedException ex, WebRequest request) {
		...
		HttpStatus status = HttpStatus.FORBIDDEN;
		ProblemType problemType = ProblemType.ACESSO_NEGADO;
		String detail = "Este tipo de cliente não tem permissão para acessar este recurso.";		
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(detail)
				.build();
	...
	//trata exceções do bean validation
	@Override
